...
dec_8 TO bin_64 CONVERTER
	convert a string of 8 char
	to a string of 64 char (each char is a bit)*/
...
bin_64 TO dec_8 CONVERTER
	convert a string of 64 char (each char is a bit) 
	to a string of 8 char.*/
...
/*	==============================================
	ENCYPT Function
	>return a DES encrypted version
	 of 'plainText'.
	==============================================	*/
...
/*	==============================================
	DECYPT Function
	>return a DES decrypted version
	 of 'cipherText'.
	==============================================	*/
