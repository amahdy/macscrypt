...
OUTPUT_PATH=dist/Release/${PLATFORM}/aes
OUTPUT_BASENAME=aes
PACKAGE_TOP_DIR=aes/
...
cd "${TOP}"
makeDirectory ${TMPDIR}/aes/bin
copyFileToTmpDir "${OUTPUT_PATH}.exe" "${TMPDIR}/${PACKAGE_TOP_DIR}bin/${OUTPUT_BASENAME}.exe" 0755


# Generate tar file
cd "${TOP}"
rm -f dist/Release/${PLATFORM}/package/aes.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Release/${PLATFORM}/package/aes.tar *
checkReturnCode
